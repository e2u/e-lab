...
import { LadderCoilGlyph, LadderContactGlyph, LadderPowerSection, LadderTransformerSection } from "../ladder/LadderGlyphs";
...
export function LadderSchematic() {
  ...
  const totalHeight = Math.max(700, startY + model.rungs.length * rungHeight + 80);
        ...
        >
          ...
          <g className="ladder-rail-left">
            <line
              ...
              y1={startY - 20}
              x2={railLeftX}
              y2={startY + model.rungs.length * rungHeight - 20}
