...
export const CATALOG: CatalogItem[] = [
  ...
  { id: "timer-on-nc", kind: "timer-on", variant: "delayed-nc", group: "計時器", label: "常閉延時斷開 NC 15-16", labelEn: "TON NC (Timed Open) 15-16", prefix: "TR", creates: "attach", defaultRot: 0 },
  { id: "timer-on-no", kind: "timer-on", variant: "delayed-no", group: "計時器", label: "常開延時閉合 NO 15-18", labelEn: "TON NO (Timed Close) 15-18", prefix: "TR", creates: "attach", defaultRot: 0 },
  { id: "timer-on-inst-nc", kind: "timer-on", variant: "inst-nc", group: "計時器", label: "通電延時瞬時常閉 NC 21-22", labelEn: "TON Inst NC 21-22", prefix: "TR", creates: "attach", defaultRot: 0 },
  { id: "timer-on-inst-no", kind: "timer-on", variant: "inst-no", group: "計時器", label: "通電延時瞬時常開 NO 21-24", labelEn: "TON Inst NO 21-24", prefix: "TR", creates: "attach", defaultRot: 0 },
  { id: "timer-off", kind: "timer-off", variant: "coil", group: "計時器", label: "斷電延時線圈", labelEn: "Timer OFF Coil", prefix: "TR", creates: "device" },
  { id: "timer-off-nc", kind: "timer-off", variant: "delayed-nc", group: "計時器", label: "常閉延時閉合 NC 15-16", labelEn: "TOF NC (Timed Close) 15-16", prefix: "TR", creates: "attach", defaultRot: 0 },
  { id: "timer-off-no", kind: "timer-off", variant: "delayed-no", group: "計時器", label: "常開延時斷開 NO 15-18", labelEn: "TOF NO (Timed Open) 15-18", prefix: "TR", creates: "attach", defaultRot: 0 },
  { id: "timer-off-inst-nc", kind: "timer-off", variant: "inst-nc", group: "計時器", label: "斷電延時瞬時常閉 NC 21-22", labelEn: "TOF Inst NC 21-22", prefix: "TR", creates: "attach", defaultRot: 0 },
  { id: "timer-off-inst-no", kind: "timer-off", variant: "inst-no", group: "計時器", label: "斷電延時瞬時常開 NO 21-24", labelEn: "TOF Inst NO 21-24", prefix: "TR", creates: "attach", defaultRot: 0 },
