...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "inspector.hideDeviceTagHint": "Still shown in Edit and Run as translucent. Only the printed diagram hides this tag.",
  ...
  zh: {
    ...
    "inspector.hideDeviceTagHint": "編輯與運行畫面仍會顯示（改為半透明），只在列印結果中隱藏此標號。",
